...
const unsigned long RAIN_DEBOUNCE = 3000;
...
void kontrolJemuran() {
    ...
    // AUTO: BUKA jemuran jika cuaca aman
    else if (cuacaAman && jemuranTertutup) {
        if (millis() - lastRainStateChange > RAIN_DEBOUNCE) {
...
void setup() {
    ...
    Serial.println("\n╔════════════════════════════════════╗");
    Serial.println("║   SMART HOME IoT - AUTO SETUP     ║");
    Serial.println("╚════════════════════════════════════╝\n");
    ...
    RAIN_THRESHOLD = rainValueDry * 0.50;
    RAIN_SAFE_THRESHOLD = rainValueDry * 0.70;
...
void loop() {
    ...
    Serial.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    Serial.println("MODE: HYBRID AUTO-MANUAL (Hujan=Auto, Web=Manual)");
