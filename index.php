...
<body>
  ...
  <div class="main-content">
    <div class="content-header">
      ...
      <div class="alert alert-info" id="ai-simple-box">
        Prediksi Cuaca AI: <strong id="ai-simple-result">Memuat...</strong>
      </div>
          ...
          <div class="card-body">
            <div class="weather-card">
              <div class="weather-icon">
                ...
                if (strpos($desc, 'hujan') !== false)
                  echo '🌧️';
                elseif (strpos($desc, 'berawan') !== false)
                  echo '☁️';
                elseif (strpos($desc, 'cerah') !== false)
                  echo '☀️';
                else
                  echo '🌤️';
                ?>
    ...
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">📊 Visualisasi Data Cuaca</h2>
      </div>
      <div class="card-body">
        <div style="text-align:center;">
          <img src="assets/pairplot.png" alt="Pairplot Cuaca"
            style="width:100%; max-width:800px; border-radius:12px;">

          <p style="margin-top:15px; font-size:14px; color:#fffff;">
            Grafik ini menunjukkan hubungan antara suhu, kelembapan, cahaya, dan intensitas hujan dengan label cuaca.
            Visualisasi ini membantu memahami pola dasar sebelum data digunakan untuk melatih model klasifikasi cuaca
            seperti <b>cerah</b>, <b>berawan</b>, dan <b>hujan</b>.
          </p>
        </div>
      </div>
    </div>
  ...
  <script>
    async function loadAISimple() {
      try {
        const sensor = <?= json_encode($sensorData) ?>;
        ...
        document.getElementById("ai-simple-result").textContent = result.hasil;

      } catch (e) {
        document.getElementById("ai-simple-result").textContent = "AI Offline";
      }
    }
    loadAISimple();
  </script>
